package com.example.group2dlicense;
...
public class License extends AppCompatActivity {
    ...
    TextView fnameRes,lnameRes,mnameRes,brgyRes,munRes,provRes,heightRes,weightRes,sexRes,nationalityRes,bdayRes,expire,idNum;
    Uri imageUri;
